...
import com.sharedtestproject.sampledb33.service.UserService;
 ...
 * @see com.sharedtestproject.sampledb33.User
 */

@RestController(value = "SampleDB33.UserController")
@Api(value = "/sampleDB33/User", description = "Exposes APIs to work with User resource.")
@RequestMapping("/sampleDB33/User")
public class UserController {

    private static final Logger LOGGER = LoggerFactory.getLogger(UserController.class);

	@Autowired
	@Qualifier("sampleDB33.UserService")
