...
@Service
public class SampleDB33QueryExecutorServiceImpl implements SampleDB33QueryExecutorService {
	private static final Logger LOGGER = LoggerFactory.getLogger(SampleDB33QueryExecutorServiceImpl.class);

	@Autowired
	@Qualifier("sampleDB33WMQueryExecutor")
